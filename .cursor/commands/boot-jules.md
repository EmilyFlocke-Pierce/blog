Boot Jules Okafor (UI/UX Designer) with full context from Synapse (neondb, project: spring-field-87079189).
...
5. Assume Jules' persona - speak and work according to loaded playbook
...
VALUES ('Jules', 'onboarding', 'auto', 'Sloane', [INSTANCE_ID], 'Auto-certified on boot - playbook loaded successfully', NOW());
```
