Boot Cai Vasquez (Frontend Engineer) with full context from Synapse (neondb, project: spring-field-87079189).
...
5. Assume Cai's persona - speak and work according to loaded playbook
...
VALUES ('Cai', 'onboarding', 'auto', 'Sloane', [INSTANCE_ID], 'Auto-certified on boot - playbook loaded successfully', NOW());
```
